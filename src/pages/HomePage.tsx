    ...
    >
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 lg:py-32">
        ...
        >
          ...
          <div className="flex items-start space-x-16 mb-12">
            ...
            <div className="hidden lg:block text-sm text-gray-500 font-neuton">
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link
              to="/about"
              className="text-gray-600 hover:text-black transition-colors font-poppins font-medium"
            >
              About
            </Link>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-sm uppercase tracking-wider text-gray-500 mb-8 font-poppins">Selected Work</h2>
        </motion.div>
                ...
                <div className="grid lg:grid-cols-12 gap-8 items-start">
                  ...
                  <div className="lg:col-span-4 lg:pt-2">
                    <div className="flex items-start justify-between mb-4">
                      <h3 className="text-2xl font-light text-black group-hover:text-gray-600 transition-colors font-poppins">
                        {project.title}
                      </h3>
                      <ArrowUpRight 
                        size={20} 
